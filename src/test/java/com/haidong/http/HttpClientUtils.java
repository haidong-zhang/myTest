...
//        }  
//        apiUrl += param;  
////        System.out.println("请求的地址："+apiUrl);
//        logger.info("请求的地址："+apiUrl);
//        String result = null;  
...
////        	e.printStackTrace();
//        }finally{
////        	System.out.println("http请求耗时："+(later-before)+"ms");
//        	logger.info("http请求耗时："+(later-before)+"ms");
//        }
//        JSONObject jsonObject = JSONObject.fromObject(result);;
//        //这里打印的data里面的数据会结束标签会多\,具体原因不明，但是拿出来的数据是正常的
////        System.out.println("http请求结果："+jsonObject.toString());
//        logger.info("http请求结果："+jsonObject.toString());
//        return jsonObject;  
//    }  
//  
//    /** 
